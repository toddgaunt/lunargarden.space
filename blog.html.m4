...
SITE_HEADER(`Blog')
	...
	POST(`b/3', `2018-04-17', `A Bit Board Representation for Hidamari', `Todd Gaunt')
	POST(`b/2', `2018-02-22', `Generic Vectors in C', `Todd Gaunt')
	POST(`b/1', `2018-02-15', `Hidamari', `Todd Gaunt')
SITE_FOOTER
